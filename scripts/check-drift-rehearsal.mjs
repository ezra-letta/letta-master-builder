...
const rehearsal = parseYaml(await fs.readFile(new URL('../maintenance/drift-rehearsal.yml', import.meta.url), 'utf8'), 'maintenance/drift-rehearsal.yml');
const versions = parseYaml(await fs.readFile(new URL('../compatibility/versions.yml', import.meta.url), 'utf8'), 'compatibility/versions.yml');
